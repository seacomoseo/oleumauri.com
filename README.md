...
[![oleumauri.com](/assets/media/logo.png)](https://oleumauri.com/)
...
- If new project (not fork):
  - Copy [oleumauri.com project files](https://github.com/oleumauri/oleumauri.com)
...
- `README.md` ⏩ edit baseURL ("oleumauri.com") + delete steps bit by bit
- Design
...
- If Netlify
  - [`Domain Management / settings`](https://app.netlify.com/sites/oleumauri/settings/domain)
  - `Add custom domain`
...
- If Cloudflare Pages
  - [Custom domains](https://dash.cloudflare.com/?to=/:account/pages/view/oleumauri/domains)
  - `Set up a custom domains`
  - `oleumauri.com`
  - `Continue`
  - `Activate domain` (if `Begin DNS transfer` end)
  - Repeat with `www.oleumauri.com`
  - ...........................................................
...
- If Netlify Form
  ...
  - [`Netlify ⏩ Site ⏩ Forms ⏩ Form Notifications`](https://app.netlify.com/sites/oleumauri/settings/forms#form-notifications) ⏩ `Add notification ⏩ Email notification ⏩ Email to Notify`
    - `Email to notify` = Emails of collaborators that want receive submissions
    - `Custom email subject line` = `Formulario de contacto de oleumauri.com`
    - `Save`
  - Submissions: [`Netlify site ⏩ Forms`](https://app.netlify.com/sites/oleumauri/forms)
...
1. [Servicios oleumauri.com](https://drive.google.com/file/d/1trq28fMfEVwoZOk4ue0tJzAJDZtj64BK) ⏩ `File ⏩ Make a copy` ⏩ Select client directory.
1. Change the info.
...
```
*ENTREGA WEB oleumauri.com:* https://seacomoseo.com/entrega/
```
